...
# ============================================
# Vision Smart AI Full Stack Entrypoint
# ============================================
# This script runs before the services start to:
# 1. Validate Gemini 3 API key is configured
# 2. Run database migrations
# 3. Start supervisor (which manages nginx and backend)

set -e

echo "=========================================="
echo "Vision Smart AI Full Stack - Starting"
echo "=========================================="
...
# Step 5: Start supervisor (manages both nginx and backend)
echo ""
echo "=========================================="
echo "Starting Vision Smart AI Full Stack"
echo "=========================================="
echo "  Gemini Model: gemini-3"
echo "  Backend Port: 3001 (internal)"
